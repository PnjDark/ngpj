  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <header className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-4xl font-bold">New Case Study</h1>
          <p className="text-neutral-500">Document the process behind your work.</p>
        </div>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-neutral-900 border border-neutral-800 p-8 rounded-2xl shadow-xl">
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-white/10"
              placeholder="How did you plan to solve it?"
              required
            ></textarea>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-white/10"
              placeholder="Step-by-step implementation..."
              required
            ></textarea>
          </div>
        ...
        <div className="flex justify-end pt-8">
          ...
          >
            <Save size={18} /> {loading ? "Creating..." : "Save Case Study"}
          </button>
        </div>
      </form>
    </div>
